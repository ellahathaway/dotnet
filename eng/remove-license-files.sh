...
### Usage: $0
###
###   Prepares and runs the file remover tooling to remove Non-OSS licenses in the VMR. Default behavior is to removal licenses
###   specifed in the disallowed-sb-license-paths file.
###
### Options:
