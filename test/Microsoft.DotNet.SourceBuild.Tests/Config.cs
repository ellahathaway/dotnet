...
internal static class Config
{
    ...
    public static string RepositoryEngineeringDir => (string)AppContext.GetData(ConfigSwitchPrefix + nameof(RepositoryEngineeringDir))! ?? throw new InvalidOperationException("RepositoryEngineeringDir must be specified");
